...
Schema:
  ...
  hook_events(id, session_id, event_type, timestamp_ms, cwd, repository, tool_name, target, user_prompt, file_path, command, tool_result, tool_result_stdout, tool_result_stderr, tool_result_interrupted, tool_result_exit_code, tool_result_status, tool_result_is_error, tool_result_error, plan, allowed_prompts, payload BLOB)
